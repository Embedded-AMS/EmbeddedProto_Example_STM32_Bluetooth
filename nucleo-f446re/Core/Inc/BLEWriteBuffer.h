...
#ifndef INC_BLEWRITEBUFFER_H_
#define INC_BLEWRITEBUFFER_H_

#include <cstdint>
#include <WriteBufferInterface.h>

class BLEWriteBuffer : public ::EmbeddedProto::WriteBufferInterface
{
    //! Store a maximum of MAX_SIZE bytes in the buffer
    static constexpr uint32_t MAX_SIZE = 50;

  public:
    BLEWriteBuffer() = default;
    ~BLEWriteBuffer() override = default;
